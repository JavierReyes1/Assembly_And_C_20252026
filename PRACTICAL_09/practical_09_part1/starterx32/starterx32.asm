...
_start:	                                 ;linker entry point
   ...
   mov	ecx,  messageAssembly                    ;message 32 Bit Register
...
message db 'Hello, x86 assembly!', 0xA    ;string to be printed
messageAssembly db 'Assembly and C!', 0xA    ;string to be printed
